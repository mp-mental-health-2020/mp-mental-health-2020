...
models = [('Logistic Regression', LogisticRegression(solver='liblinear', multi_class='ovr')), ('LDA', LinearDiscriminantAnalysis()),
          ...
          ('NB', GaussianNB()), ('SVC', SVC()), ('XGBoost mult', XGBClassifier(objective="multi:softprob", random_state=42))]


# ('XGBoost binary', XGBClassifier(objective="binary:logistic", random_state=42))
