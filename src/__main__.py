...
def autocorrelation_phyphox():
    ...
    data_frame_acceleration = get_data_frame_from_sensor_data(data_frame, "acceleration")
    mean_coefficient_data_frame_acceleration = calculate_auto_correlation_coefficients(data_frame_acceleration)

    # calculate auto-correlation coefficients for gyroscope
    data_frame_gyroscope = get_data_frame_from_sensor_data(data_frame, "gyroscope")
    mean_coefficient_data_frame_gyroscope = calculate_auto_correlation_coefficients(data_frame_gyroscope)
...
def calculate_auto_correlation_coefficients(data_frame):
    ...
    return mean_coefficient_data_frame
